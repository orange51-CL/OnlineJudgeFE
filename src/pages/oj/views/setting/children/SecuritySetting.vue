    ...
    <div class="flex-container setting-content">
      <template v-for="session in sessions">
        <Card :padding="20" class="flex-child">
          ...
          <div slot="extra">
            <Tag v-if="session.current_session" color="green">最新</Tag>
            <Button v-else
                    type="warning"
                    size="small"
          ...
          <Form :label-width="100">
            ...
            <FormItem label="浏览器版本 :" class="item">
              {{session.user_agent | browser}}
            </FormItem>
            <FormItem label="上次登录 :" class="item">
      ...
      <Form>
        ...
        <template v-if="!loadingQRcode">
          <FormItem style="width: 250px">
            <Input v-model="formTwoFactor.code" placeholder="输入你的验证码"/>
          </FormItem>
          <Button type="primary"
                  :loading="loadingBtn"
