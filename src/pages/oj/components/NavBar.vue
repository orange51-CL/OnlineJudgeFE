      ...
      <template v-else>
        <Dropdown class="drop-menu" @on-click="handleRoute" placement="bottom" trigger="click">
          ...
          <Dropdown-menu slot="list">
            ...
            <Dropdown-item name="/status?myself=1">个人提交记录</Dropdown-item>
            <Dropdown-item name="/setting/profile">设置</Dropdown-item>
            <Dropdown-item v-if="isAdminRole" name="/admin">管理</Dropdown-item>
            <Dropdown-item divided name="/logout">登出</Dropdown-item>
          </Dropdown-menu>
        </Dropdown>
      </template>
    </Menu>
    <Modal v-model="modalVisible" :width="400">
      <div slot="header" class="modal-title">欢迎登录 {{website.website_name_shortcut}}^_^</div>
