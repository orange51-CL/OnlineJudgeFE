  ...
  <div class="problem">
    ...
    <Panel :title="title">
      <el-form ref="form" :model="problem" :rules="rules" label-position="top" label-width="70px">
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item prop="_id" label="显示 ID"
                          :required="this.routeName === 'create-contest-problem' || this.routeName === 'edit-contet-problem'">
              <el-input placeholder="显示 ID" v-model="problem._id"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="18">
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item prop="input_description" label="输入样例描述" required>
              <Simditor v-model="problem.input_description"></Simditor>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item prop="output_description" label="输出样例描述" required>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <el-form-item label="难度">
              <el-select class="difficulty-select" size="small" placeholder="难度" v-model="problem.difficulty">
        ...
        <el-form-item label="特殊判题" :error="error.spj">
          <el-col :span="24">
            <el-checkbox v-model="problem.spj" @click.native.prevent="switchSpj()">使用特殊判题</el-checkbox>
          </el-col>
        </el-form-item>
        <el-form-item v-if="problem.spj">
          <Accordion title="特殊判题代码">
