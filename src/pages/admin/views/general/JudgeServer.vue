      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="props">
            ...
            <p>服务器地址: <code>{{ props.row.service_url }}</code></p>
            <p>下一次心跳: {{ props.row.last_heartbeat | localtime}}</p>
  ...
  export default {
    ...
    methods: {
      ...
      deleteJudgeServer (hostname) {
        this.$confirm('如果你删除这个判题服务器, 在下一次心跳之前你将不能使用判题服务！', '警告', {
