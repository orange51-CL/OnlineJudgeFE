<template>
  <el-row type="flex" :gutter="20">
    <el-col :md="10" :lg="8">
      ...
      <panel title="评测系统预览" v-if="isSuperAdmin">
    ...
    <el-col :md="14" :lg="16" v-if="isSuperAdmin">
      <div class="info-container">
        ...
        <info-card color="#67C23A" icon="el-icon-fa-list" message="总提交数" class="info-item"
      ...
      <panel style="margin-top: 5px">
        <span slot="title" v-loading="loadingReleases">版本说明
        <el-popover placement="right" trigger="hover">
          <i slot="reference" class="el-icon-fa-question-circle import-user-icon"></i>
          <p>请升级到最新版本,以体验最新功能. </p>
          <p>链接: <a href="http://docs.onlinejudge.me/#/onlinejudge/guide/upgrade" target="_blank">
